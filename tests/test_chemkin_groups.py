...
class TestClassBasic:
    """
    Tests to verify Chemkin utilites for
    ...
    def test_utilities(self, get_working_dir, get_source_dir, get_result_dir, test_file):
        """
        Run the selected pychemin utility test case.
        """
        iErr = PyCKtools.run_test(get_working_dir, get_source_dir, get_result_dir, test_file)
...
class TestClassEquilibrium:
    ...
    def test_equilibrium(self, get_working_dir, get_source_dir, get_result_dir, test_file):
        """
