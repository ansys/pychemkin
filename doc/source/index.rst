...
PyChemkin (Ansys-chemkin package) provides pythonic access to Ansys Chemkin. It facilitates programmatic customization of
Chemkin simulation workflow within the Python ecosystem and permits access to Chemkin property and rate utilities as well as
...
.. grid::   1 2 3 3
    ...
    .. grid-item-card:: User guide :fa:`book-open-reader`
        ...
        Access Chemkin manuals to learn about parameters, options,
        and theory of property evaluations and reactor models.
    ...
    .. grid-item-card:: Examples :fa:`scroll`
        ...
        reactor models to perform many different types of simulations.
