...
The `PyChemkin wiki`_ provides additional project information, guidance, and
community resources beyond the official documentation.
...
- `Artifacts`_. Contains download link to the artifacts generated by the project,
  like wheels and source distribution files. Additional targets are available too.
...
.. _PyChemkin wiki: https://github.com/ansys/pychemkin/wiki
